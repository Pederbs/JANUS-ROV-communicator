...
int JANUS_RX_PORT1 = 9920;
int JANUS_TX_PORT1 = 9914;
int JANUS_RX_PORT2 = 9920;
int JANUS_TX_PORT2 = 9914;
...
public:
    PubSubNode() : Node("evo_communicator")
    {
        ...
        Evo_janusXsdm::connection modemTX(IP,JANUS_PATH,SDM_PATH, JANUS_RX_PORT1,JANUS_TX_PORT1,STREAMFS); 
        Evo_janusXsdm::connection modemRX(IP,JANUS_PATH,SDM_PATH, JANUS_RX_PORT2,JANUS_TX_PORT2,STREAMFS); 
        //Configures modem and sets preamble
        modemTX.sdmConfigAir();
        modemRX.sdmConfigAir();
        std::cout << "Print: 1\n";
